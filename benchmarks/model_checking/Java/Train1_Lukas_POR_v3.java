...
public class Train1_Lukas_POR_v3 {
    ...
    public BSet<ROUTES> _tr_route_reservation() {
        BSet<ROUTES> _ic_set_0 = new BSet<ROUTES>();
        for(ROUTES _ic_r_1 : _ROUTES.difference(resrt)) {
            if((new BBoolean(rtbl.inverse().relationImage(new BSet<ROUTES>(_ic_r_1)).intersect(resbl).equal(new BSet<BLOCKS>()).booleanValue() && new BSet<ROUTES>().equal(resrt.difference(rsrtbl.range())).booleanValue())).booleanValue()) {
                _ic_set_0 = _ic_set_0.union(new BSet<ROUTES>(_ic_r_1));
            }
    ...
    public BSet<BLOCKS> _tr_FRONT_MOVE_2() {
        BSet<BLOCKS> _ic_set_3 = new BSet<BLOCKS>();
        for(BLOCKS _ic_b_1 : OCC.intersect(TRK.domain())) {
            if((new BBoolean(OCC.notElementOf(TRK.functionCall(_ic_b_1)).booleanValue() && new BSet<ROUTES>().equal(resrt.difference(rsrtbl.range())).booleanValue())).booleanValue()) {
                _ic_set_3 = _ic_set_3.union(new BSet<BLOCKS>(_ic_b_1));
            }
    ...
    public BSet<ROUTES> _tr_point_positionning() {
        BSet<ROUTES> _ic_set_6 = new BSet<ROUTES>();
        for(ROUTES _ic_r_1 : resrt.difference(frm)) {
            if((new BSet<ROUTES>().equal(resrt.difference(rsrtbl.range()))).booleanValue()) {
                _ic_set_6 = _ic_set_6.union(new BSet<ROUTES>(_ic_r_1));
            }
    ...
    public Train1_Lukas_POR_v3 _copy() {
        return new Train1_Lukas_POR_v3(fst, lst, nxt, rtbl, LBT, TRK, frm, OCC, resbl, resrt, rsrtbl);
    }

    @Override
    public boolean equals(Object o) {
        Train1_Lukas_POR_v3 o1 = this;
        Train1_Lukas_POR_v3 o2 = (Train1_Lukas_POR_v3) o;

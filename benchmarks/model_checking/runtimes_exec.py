...
calculate_statistics(data_java, 3, 1, True, "false")
print('----------------------------')
print('C++ (Single-threaded, No Caching):')
calculate_statistics(data_cpp, 0, 1, True, "false")
print('----------------------------')
print('JS (Single-threaded, No Caching):')
calculate_statistics(data_js, 1, 1, False, "false")
print('----------------------------')

print('Java (Single-threaded, Caching):')
calculate_statistics(data_java, 3, 1, True, "true")
print('----------------------------')
print('C++ (Single-threaded, Caching):')
calculate_statistics(data_cpp, 0, 1, True, "true")
print('----------------------------')
print('JS (Single-threaded, Caching):')
calculate_statistics(data_js, 1, 1, False, "true")
print('----------------------------')


print('Java (Multi-threaded, No Caching):')
calculate_statistics(data_java, 3, 6, True, "false")
print('----------------------------')
print('C++ (Multi-threaded, No Caching):')
calculate_statistics(data_cpp, 0, 6, True, "false")
print('----------------------------')

print('Java (Multi-threaded, Caching):')
calculate_statistics(data_java, 3, 6, True, "true")
print('----------------------------')
print('C++ (Multi-threaded, Caching):')
calculate_statistics(data_cpp, 0, 6, True, "true")
print('----------------------------')

    ...
    public:
        ...
        void modelCheckSingleThreaded() {
            ...
            while(!unvisitedStates.empty()) {
                ...
                for(const Cruise_finite1_deterministic_MC& nextState : nextStates) {

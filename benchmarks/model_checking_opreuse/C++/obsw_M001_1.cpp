...
#ifndef obsw_M001_1_H
#define obsw_M001_1_H
...
class obsw_M001_1 {
    ...
    public:
        ...
        struct Hash {
            public:
                size_t operator()(const obsw_M001_1& obj) const {
                    return obj.hashCode();
                }
        };
        ...
        struct HashEqual {
            public:
                bool operator()(const obsw_M001_1& obj1, const obsw_M001_1& obj2) const {
                    if (obj1 == obj2)
                        return true;
                    else
                        return false;
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream &strm, const obsw_M001_1& machine) {
...
class ModelChecker {
    private:
        obsw_M001_1::Type type;
        int threads;
        bool isCaching;
        bool isDebug;

        std::list<obsw_M001_1> unvisitedStates;
        std::unordered_set<obsw_M001_1, obsw_M001_1::Hash, obsw_M001_1::HashEqual> states;
        ...
        obsw_M001_1 counterExampleState;

        std::unordered_map<BSet<BTuple<obsw_M001_1::TC_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>, std::unordered_map<obsw_M001_1::_ProjectionRead_env_Receive_TC, obsw_M001_1::_ProjectionWrite_env_Receive_TC, obsw_M001_1::_ProjectionRead_env_Receive_TC::Hash, obsw_M001_1::_ProjectionRead_env_Receive_TC::HashEqual>, BSet<BTuple<obsw_M001_1::TC_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>::SetHash, BSet<BTuple<obsw_M001_1::TC_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>::SetHashEqual> _OpCache_env_Receive_TC;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_env_Receive_TC,  BSet<BTuple<obsw_M001_1::TC_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>, obsw_M001_1::_ProjectionRead__tr_env_Receive_TC::Hash, obsw_M001_1::_ProjectionRead__tr_env_Receive_TC::HashEqual> _OpCache_tr_env_Receive_TC;
        std::mutex _ProjectionRead_env_Receive_TC_mutex;
        std::mutex _ProjectionRead__tr_env_Receive_TC_mutex;

        std::unordered_map<BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Poll_TC, obsw_M001_1::_ProjectionWrite_Poll_TC, obsw_M001_1::_ProjectionRead_Poll_TC::Hash, obsw_M001_1::_ProjectionRead_Poll_TC::HashEqual>, BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>::SetHash, BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>::SetHashEqual> _OpCache_Poll_TC;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Poll_TC,  BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_BUFFER >>, obsw_M001_1::_ProjectionRead__tr_Poll_TC::Hash, obsw_M001_1::_ProjectionRead__tr_Poll_TC::HashEqual> _OpCache_tr_Poll_TC;
        std::mutex _ProjectionRead_Poll_TC_mutex;
        std::mutex _ProjectionRead__tr_Poll_TC_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Accept_TC, obsw_M001_1::_ProjectionWrite_Accept_TC, obsw_M001_1::_ProjectionRead_Accept_TC::Hash, obsw_M001_1::_ProjectionRead_Accept_TC::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Accept_TC;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Accept_TC,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Accept_TC::Hash, obsw_M001_1::_ProjectionRead__tr_Accept_TC::HashEqual> _OpCache_tr_Accept_TC;
        std::mutex _ProjectionRead_Accept_TC_mutex;
        std::mutex _ProjectionRead__tr_Accept_TC_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Reject_TC, obsw_M001_1::_ProjectionWrite_Reject_TC, obsw_M001_1::_ProjectionRead_Reject_TC::Hash, obsw_M001_1::_ProjectionRead_Reject_TC::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Reject_TC;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Reject_TC,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Reject_TC::Hash, obsw_M001_1::_ProjectionRead__tr_Reject_TC::HashEqual> _OpCache_tr_Reject_TC;
        std::mutex _ProjectionRead_Reject_TC_mutex;
        std::mutex _ProjectionRead__tr_Reject_TC_mutex;

        std::unordered_map<BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Report_TC_Acceptance, obsw_M001_1::_ProjectionWrite_Report_TC_Acceptance, obsw_M001_1::_ProjectionRead_Report_TC_Acceptance::Hash, obsw_M001_1::_ProjectionRead_Report_TC_Acceptance::HashEqual>, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHash, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHashEqual> _OpCache_Report_TC_Acceptance;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Report_TC_Acceptance,  BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, obsw_M001_1::_ProjectionRead__tr_Report_TC_Acceptance::Hash, obsw_M001_1::_ProjectionRead__tr_Report_TC_Acceptance::HashEqual> _OpCache_tr_Report_TC_Acceptance;
        std::mutex _ProjectionRead_Report_TC_Acceptance_mutex;
        std::mutex _ProjectionRead__tr_Report_TC_Acceptance_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Skip_TC_Acceptance_Report, obsw_M001_1::_ProjectionWrite_Skip_TC_Acceptance_Report, obsw_M001_1::_ProjectionRead_Skip_TC_Acceptance_Report::Hash, obsw_M001_1::_ProjectionRead_Skip_TC_Acceptance_Report::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Skip_TC_Acceptance_Report;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Skip_TC_Acceptance_Report,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Acceptance_Report::Hash, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Acceptance_Report::HashEqual> _OpCache_tr_Skip_TC_Acceptance_Report;
        std::mutex _ProjectionRead_Skip_TC_Acceptance_Report_mutex;
        std::mutex _ProjectionRead__tr_Skip_TC_Acceptance_Report_mutex;

        std::unordered_map<BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Report_TC_Rejection, obsw_M001_1::_ProjectionWrite_Report_TC_Rejection, obsw_M001_1::_ProjectionRead_Report_TC_Rejection::Hash, obsw_M001_1::_ProjectionRead_Report_TC_Rejection::HashEqual>, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHash, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHashEqual> _OpCache_Report_TC_Rejection;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Report_TC_Rejection,  BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, obsw_M001_1::_ProjectionRead__tr_Report_TC_Rejection::Hash, obsw_M001_1::_ProjectionRead__tr_Report_TC_Rejection::HashEqual> _OpCache_tr_Report_TC_Rejection;
        std::mutex _ProjectionRead_Report_TC_Rejection_mutex;
        std::mutex _ProjectionRead__tr_Report_TC_Rejection_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Skip_TC_Rejection_Report, obsw_M001_1::_ProjectionWrite_Skip_TC_Rejection_Report, obsw_M001_1::_ProjectionRead_Skip_TC_Rejection_Report::Hash, obsw_M001_1::_ProjectionRead_Skip_TC_Rejection_Report::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Skip_TC_Rejection_Report;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Skip_TC_Rejection_Report,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Rejection_Report::Hash, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Rejection_Report::HashEqual> _OpCache_tr_Skip_TC_Rejection_Report;
        std::mutex _ProjectionRead_Skip_TC_Rejection_Report_mutex;
        std::mutex _ProjectionRead__tr_Skip_TC_Rejection_Report_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Execute_TC_Successfully, obsw_M001_1::_ProjectionWrite_Execute_TC_Successfully, obsw_M001_1::_ProjectionRead_Execute_TC_Successfully::Hash, obsw_M001_1::_ProjectionRead_Execute_TC_Successfully::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Execute_TC_Successfully;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Execute_TC_Successfully,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Execute_TC_Successfully::Hash, obsw_M001_1::_ProjectionRead__tr_Execute_TC_Successfully::HashEqual> _OpCache_tr_Execute_TC_Successfully;
        ...
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Reset_TM_Buffer,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Reset_TM_Buffer::Hash, obsw_M001_1::_ProjectionRead__tr_Reset_TM_Buffer::HashEqual> _OpCache_tr_Reset_TM_Buffer;
        ...
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Fail_TC_Execution,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Fail_TC_Execution::Hash, obsw_M001_1::_ProjectionRead__tr_Fail_TC_Execution::HashEqual> _OpCache_tr_Fail_TC_Execution;
        std::mutex _ProjectionRead_Fail_TC_Execution_mutex;
        std::mutex _ProjectionRead__tr_Fail_TC_Execution_mutex;

        std::unordered_map<BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Report_TC_Execution_Success, obsw_M001_1::_ProjectionWrite_Report_TC_Execution_Success, obsw_M001_1::_ProjectionRead_Report_TC_Execution_Success::Hash, obsw_M001_1::_ProjectionRead_Report_TC_Execution_Success::HashEqual>, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHash, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHashEqual> _OpCache_Report_TC_Execution_Success;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Report_TC_Execution_Success,  BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, obsw_M001_1::_ProjectionRead__tr_Report_TC_Execution_Success::Hash, obsw_M001_1::_ProjectionRead__tr_Report_TC_Execution_Success::HashEqual> _OpCache_tr_Report_TC_Execution_Success;
        ...
        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Skip_TC_Success_Report, obsw_M001_1::_ProjectionWrite_Skip_TC_Success_Report, obsw_M001_1::_ProjectionRead_Skip_TC_Success_Report::Hash, obsw_M001_1::_ProjectionRead_Skip_TC_Success_Report::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Skip_TC_Success_Report;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Skip_TC_Success_Report,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Success_Report::Hash, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Success_Report::HashEqual> _OpCache_tr_Skip_TC_Success_Report;
        std::mutex _ProjectionRead_Skip_TC_Success_Report_mutex;
        std::mutex _ProjectionRead__tr_Skip_TC_Success_Report_mutex;

        std::unordered_map<BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Report_TC_Execution_Failure, obsw_M001_1::_ProjectionWrite_Report_TC_Execution_Failure, obsw_M001_1::_ProjectionRead_Report_TC_Execution_Failure::Hash, obsw_M001_1::_ProjectionRead_Report_TC_Execution_Failure::HashEqual>, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHash, BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHashEqual> _OpCache_Report_TC_Execution_Failure;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Report_TC_Execution_Failure,  BSet<BTuple<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL, obsw_M001_1::TM_SET >, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, obsw_M001_1::_ProjectionRead__tr_Report_TC_Execution_Failure::Hash, obsw_M001_1::_ProjectionRead__tr_Report_TC_Execution_Failure::HashEqual> _OpCache_tr_Report_TC_Execution_Failure;
        ...
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Skip_TC_Failure_Report,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Failure_Report::Hash, obsw_M001_1::_ProjectionRead__tr_Skip_TC_Failure_Report::HashEqual> _OpCache_tr_Skip_TC_Failure_Report;
        std::mutex _ProjectionRead_Skip_TC_Failure_Report_mutex;
        std::mutex _ProjectionRead__tr_Skip_TC_Failure_Report_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Drop_TC, obsw_M001_1::_ProjectionWrite_Drop_TC, obsw_M001_1::_ProjectionRead_Drop_TC::Hash, obsw_M001_1::_ProjectionRead_Drop_TC::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>::SetHashEqual> _OpCache_Drop_TC;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Drop_TC,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TC_POOL>, obsw_M001_1::_ProjectionRead__tr_Drop_TC::Hash, obsw_M001_1::_ProjectionRead__tr_Drop_TC::HashEqual> _OpCache_tr_Drop_TC;
        std::mutex _ProjectionRead_Drop_TC_mutex;
        std::mutex _ProjectionRead__tr_Drop_TC_mutex;

        std::unordered_map<BSet<BTuple<obsw_M001_1::TM_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Produce_TM, obsw_M001_1::_ProjectionWrite_Produce_TM, obsw_M001_1::_ProjectionRead_Produce_TM::Hash, obsw_M001_1::_ProjectionRead_Produce_TM::HashEqual>, BSet<BTuple<obsw_M001_1::TM_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHash, BSet<BTuple<obsw_M001_1::TM_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>::SetHashEqual> _OpCache_Produce_TM;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Produce_TM,  BSet<BTuple<obsw_M001_1::TM_SET, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL >>, obsw_M001_1::_ProjectionRead__tr_Produce_TM::Hash, obsw_M001_1::_ProjectionRead__tr_Produce_TM::HashEqual> _OpCache_tr_Produce_TM;
        std::mutex _ProjectionRead_Produce_TM_mutex;
        std::mutex _ProjectionRead__tr_Produce_TM_mutex;

        std::unordered_map<BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER >>, std::unordered_map<obsw_M001_1::_ProjectionRead_Pass_TM, obsw_M001_1::_ProjectionWrite_Pass_TM, obsw_M001_1::_ProjectionRead_Pass_TM::Hash, obsw_M001_1::_ProjectionRead_Pass_TM::HashEqual>, BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER >>::SetHash, BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER >>::SetHashEqual> _OpCache_Pass_TM;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Pass_TM,  BSet<BTuple<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL, obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER >>, obsw_M001_1::_ProjectionRead__tr_Pass_TM::Hash, obsw_M001_1::_ProjectionRead__tr_Pass_TM::HashEqual> _OpCache_tr_Pass_TM;
        std::mutex _ProjectionRead_Pass_TM_mutex;
        std::mutex _ProjectionRead__tr_Pass_TM_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Cancel_TM, obsw_M001_1::_ProjectionWrite_Cancel_TM, obsw_M001_1::_ProjectionRead_Cancel_TM::Hash, obsw_M001_1::_ProjectionRead_Cancel_TM::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>::SetHashEqual> _OpCache_Cancel_TM;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Cancel_TM,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>, obsw_M001_1::_ProjectionRead__tr_Cancel_TM::Hash, obsw_M001_1::_ProjectionRead__tr_Cancel_TM::HashEqual> _OpCache_tr_Cancel_TM;
        std::mutex _ProjectionRead_Cancel_TM_mutex;
        std::mutex _ProjectionRead__tr_Cancel_TM_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>, std::unordered_map<obsw_M001_1::_ProjectionRead_Drop_TM, obsw_M001_1::_ProjectionWrite_Drop_TM, obsw_M001_1::_ProjectionRead_Drop_TM::Hash, obsw_M001_1::_ProjectionRead_Drop_TM::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>::SetHashEqual> _OpCache_Drop_TM;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_Drop_TM,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_POOL>, obsw_M001_1::_ProjectionRead__tr_Drop_TM::Hash, obsw_M001_1::_ProjectionRead__tr_Drop_TM::HashEqual> _OpCache_tr_Drop_TM;
        std::mutex _ProjectionRead_Drop_TM_mutex;
        std::mutex _ProjectionRead__tr_Drop_TM_mutex;

        std::unordered_map<BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER>, std::unordered_map<obsw_M001_1::_ProjectionRead_env_Deliver_TM, obsw_M001_1::_ProjectionWrite_env_Deliver_TM, obsw_M001_1::_ProjectionRead_env_Deliver_TM::Hash, obsw_M001_1::_ProjectionRead_env_Deliver_TM::HashEqual>, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER>::SetHash, BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER>::SetHashEqual> _OpCache_env_Deliver_TM;
        std::unordered_map<obsw_M001_1::_ProjectionRead__tr_env_Deliver_TM,  BSet<obsw_M001_1::PACKET_START_ADDRESSES_IN_TM_BUFFER>, obsw_M001_1::_ProjectionRead__tr_env_Deliver_TM::Hash, obsw_M001_1::_ProjectionRead__tr_env_Deliver_TM::HashEqual> _OpCache_tr_env_Deliver_TM;
        std::mutex _ProjectionRead_env_Deliver_TM_mutex;
        std::mutex _ProjectionRead__tr_env_Deliver_TM_mutex;

        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_1, bool, obsw_M001_1::_ProjectionRead__check_inv_1::Hash, obsw_M001_1::_ProjectionRead__check_inv_1::HashEqual> _InvCache__check_inv_1;
        std::mutex _ProjectionRead__check_inv_1_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_2, bool, obsw_M001_1::_ProjectionRead__check_inv_2::Hash, obsw_M001_1::_ProjectionRead__check_inv_2::HashEqual> _InvCache__check_inv_2;
        std::mutex _ProjectionRead__check_inv_2_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_3, bool, obsw_M001_1::_ProjectionRead__check_inv_3::Hash, obsw_M001_1::_ProjectionRead__check_inv_3::HashEqual> _InvCache__check_inv_3;
        std::mutex _ProjectionRead__check_inv_3_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_4, bool, obsw_M001_1::_ProjectionRead__check_inv_4::Hash, obsw_M001_1::_ProjectionRead__check_inv_4::HashEqual> _InvCache__check_inv_4;
        std::mutex _ProjectionRead__check_inv_4_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_5, bool, obsw_M001_1::_ProjectionRead__check_inv_5::Hash, obsw_M001_1::_ProjectionRead__check_inv_5::HashEqual> _InvCache__check_inv_5;
        std::mutex _ProjectionRead__check_inv_5_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_6, bool, obsw_M001_1::_ProjectionRead__check_inv_6::Hash, obsw_M001_1::_ProjectionRead__check_inv_6::HashEqual> _InvCache__check_inv_6;
        std::mutex _ProjectionRead__check_inv_6_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_7, bool, obsw_M001_1::_ProjectionRead__check_inv_7::Hash, obsw_M001_1::_ProjectionRead__check_inv_7::HashEqual> _InvCache__check_inv_7;
        std::mutex _ProjectionRead__check_inv_7_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_8, bool, obsw_M001_1::_ProjectionRead__check_inv_8::Hash, obsw_M001_1::_ProjectionRead__check_inv_8::HashEqual> _InvCache__check_inv_8;
        std::mutex _ProjectionRead__check_inv_8_mutex;
        std::unordered_map<obsw_M001_1::_ProjectionRead__check_inv_9, bool, obsw_M001_1::_ProjectionRead__check_inv_9::Hash, obsw_M001_1::_ProjectionRead__check_inv_9::HashEqual> _InvCache__check_inv_9;
        std::mutex _ProjectionRead__check_inv_9_mutex;

        std::unordered_map<obsw_M001_1, obsw_M001_1, obsw_M001_1::Hash, obsw_M001_1::HashEqual> parents;

    public:
        ModelChecker() {}

        ModelChecker(obsw_M001_1::Type type, int threads, bool isCaching, bool isDebug) {
            this->type = type;
        ...
        void modelCheckSingleThreaded() {
            obsw_M001_1 machine = obsw_M001_1();
            ...
            while(!unvisitedStates.empty()) {
                ...
                for(const obsw_M001_1& nextState : nextStates) {
    ...
    private:
        obsw_M001_1 next() {
            {
                std::unique_lock<std::mutex> lock(mutex);
                switch(type) {
                    case obsw_M001_1::BFS: {
                        obsw_M001_1 state = unvisitedStates.front();
                        unvisitedStates.pop_front();
                        return state;
                    }
                    case obsw_M001_1::DFS: {
                        obsw_M001_1 state = unvisitedStates.back();
                        unvisitedStates.pop_back();
                        return state;
                    }
                    case obsw_M001_1::MIXED: {
        ...
        std::unordered_set<obsw_M001_1, obsw_M001_1::Hash, obsw_M001_1::HashEqual> generateNextStates(const obsw_M001_1& state) {
        ...
        bool invariantViolated(const obsw_M001_1& state) {
            bool _check_inv_1 = true;
            if(isCaching) {
                {
                    std::unique_lock<std::mutex> _ProjectionRead__check_inv_1_lock(_ProjectionRead__check_inv_1_mutex);
                    obsw_M001_1::_ProjectionRead__check_inv_1 read__check_inv_1_state = state._projected_state_for__check_inv_1();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_2 read__check_inv_2_state = state._projected_state_for__check_inv_2();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_3 read__check_inv_3_state = state._projected_state_for__check_inv_3();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_4 read__check_inv_4_state = state._projected_state_for__check_inv_4();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_5 read__check_inv_5_state = state._projected_state_for__check_inv_5();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_6 read__check_inv_6_state = state._projected_state_for__check_inv_6();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_7 read__check_inv_7_state = state._projected_state_for__check_inv_7();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_8 read__check_inv_8_state = state._projected_state_for__check_inv_8();
            ...
            if(isCaching) {
                {
                    ...
                    obsw_M001_1::_ProjectionRead__check_inv_9 read__check_inv_9_state = state._projected_state_for__check_inv_9();

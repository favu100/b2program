...
export default class obsw_M001_2 {
    ...
    */
    ...
    _tr_env_Receive_TC(): BSet<BTuple<TC_SET, PACKET_START_ADDRESSES_IN_TC_BUFFER>> {
        ...
        for(let _ic_tc_pointer_1 of obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_BUFFER) {
            if(this.TCbuffer.isNotInDomain(_ic_tc_pointer_1).booleanValue()) {
                for(let _ic_tc_1 of obsw_M001_2._TC_SET) {
                    if((obsw_M001_2._TC_SET.elementOf(_ic_tc_1)).booleanValue()) {
    ...
    _tr_Poll_TC(): BSet<BTuple<PACKET_START_ADDRESSES_IN_TC_POOL, PACKET_START_ADDRESSES_IN_TC_BUFFER>> {
        ...
        for(let _ic_tc_pointer_1 of this.TCbuffer.domain()) {
            for(let _ic_tc_handler_1 of obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_POOL) {
    ...
    _tr_Accept_TC(): BSet<PACKET_START_ADDRESSES_IN_TC_POOL> {
        ...
        for(let _ic_tc_handler_1 of this.TCpool.domain()) {
            if((new BBoolean(new BBoolean(obsw_M001_2.VALID_TCS.elementOf(this.TCpool.functionCall(_ic_tc_handler_1)).booleanValue() && this.TCstatus.isInDomain(_ic_tc_handler_1).booleanValue()).booleanValue() && this.TCstatus.functionCall(_ic_tc_handler_1).equal(new TC_STATUSES(enum_TC_STATUSES.TC_Unchecked)).booleanValue())).booleanValue()) {
        ...
        for(let _ic_tc_handler_1 of this.TCpool.domain()) {
            if(this.TCstatus.isInDomain(_ic_tc_handler_1).booleanValue()) {
                if(this.TCstatus.functionCall(_ic_tc_handler_1).equal(new TC_STATUSES(enum_TC_STATUSES.TC_Accepted)).booleanValue()) {
                    for(let _ic_tm_1 of obsw_M001_2._TM_SET) {
                        for(let _ic_tm_handler_1 of obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_POOL) {
        ...
        for(let _ic_tm_handler_1 of this.TMpool.domain()) {
            if(this.TMstatus.isInDomain(_ic_tm_handler_1).booleanValue()) {
                if(this.TMstatus.functionCall(_ic_tm_handler_1).equal(new TM_STATUSES(enum_TM_STATUSES.TM_Effective)).booleanValue()) {
                    for(let _ic_tm_pointer_1 of obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_BUFFER) {
    ...
    _check_inv_1() {
        return this.TCstatus.checkDomain(obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_POOL).and(this.TCstatus.checkRange(obsw_M001_2._TC_STATUSES)).and(this.TCstatus.isFunction()).and(this.TCstatus.isPartial(obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_POOL)).booleanValue();
    }
    ...
    _check_inv_3() {
        ...
        for(let _ic_tc_handler_1 of this.TCstatus.domain()) {
            if(!(new BBoolean(!new BSet<TC_STATUSES>(new TC_STATUSES(enum_TC_STATUSES.TC_Accepted), new TC_STATUSES(enum_TC_STATUSES.TC_Waiting_for_Execution), new TC_STATUSES(enum_TC_STATUSES.TC_Successfully_Executed), new TC_STATUSES(enum_TC_STATUSES.TC_Execution_Failed)).elementOf(this.TCstatus.functionCall(_ic_tc_handler_1)).booleanValue() || obsw_M001_2.VALID_TCS.elementOf(this.TCpool.functionCall(_ic_tc_handler_1)).booleanValue())).booleanValue()) {
    ...
    _check_inv_4() {
        return this.TMstatus.checkDomain(obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_POOL).and(this.TMstatus.checkRange(obsw_M001_2._TM_STATUSES)).and(this.TMstatus.isFunction()).and(this.TMstatus.isPartial(obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_POOL)).booleanValue();
    }
    ...
    _check_inv_6() {
        return this.TCbuffer.checkDomain(obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_BUFFER).and(this.TCbuffer.checkRange(obsw_M001_2._TC_SET)).and(this.TCbuffer.isFunction()).and(this.TCbuffer.isPartial(obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_BUFFER)).booleanValue();
    }

    _check_inv_7() {
        return this.TMbuffer.checkDomain(obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_BUFFER).and(this.TMbuffer.checkRange(obsw_M001_2._TM_SET)).and(this.TMbuffer.isFunction()).and(this.TMbuffer.isPartial(obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_BUFFER)).booleanValue();
    }

    _check_inv_8() {
        return this.TCpool.checkDomain(obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_POOL).and(this.TCpool.checkRange(obsw_M001_2._TC_SET)).and(this.TCpool.isFunction()).and(this.TCpool.isPartial(obsw_M001_2._PACKET_START_ADDRESSES_IN_TC_POOL)).booleanValue();
    }

    _check_inv_9() {
        return this.TMpool.checkDomain(obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_POOL).and(this.TMpool.checkRange(obsw_M001_2._TM_SET)).and(this.TMpool.isFunction()).and(this.TMpool.isPartial(obsw_M001_2._PACKET_START_ADDRESSES_IN_TM_POOL)).booleanValue();
    }


    public _copy(): obsw_M001_2 {
...
export class ModelChecker {
    ...
    private unvisitedStates: LinkedList<obsw_M001_2> = new LinkedList<obsw_M001_2>;
    private states: immutable.Set<obsw_M001_2> = new immutable.Set();
    private transitions: number = 0;

    private invariantViolated: boolean = false;
    private deadlockDetected: boolean = false;
    private counterExampleState: obsw_M001_2 = undefined;
    ...
    modelCheckSingleThreaded(): void {
        let machine: obsw_M001_2 = new obsw_M001_2();
        this.states = this.states.add(machine);
        this.unvisitedStates.pushBack(machine);

        while(!(this.unvisitedStates.length === 0)) {
            let state: obsw_M001_2 = this.next();

            let nextStates: Set<obsw_M001_2> = this.generateNextStates(state);
    ...
    generateNextStates(state: obsw_M001_2): Set<obsw_M001_2> {
        let result: immutable.Set<obsw_M001_2> = immutable.Set();
        if(this.isCaching) {
            ...
            for(let param of _trid_1) {
                ...
                let copiedState: obsw_M001_2 = state._copy();
    ...
    invViolated(state: obsw_M001_2): boolean {

...
public class Train_1_beebook_deterministic_MC_POR_v2 {
    ...
    public Train_1_beebook_deterministic_MC_POR_v2(Train_1_beebook_deterministic_MC_POR_v2 copy) {
        this.fst = copy.fst;
        this.lst = copy.lst;
        this.nxt = copy.nxt;
        this.rtbl = copy.rtbl;
    ...
    public boolean _check_inv_3() {
        ...
        for(BLOCKS _ic_x_1 : TRK.domain()) {
            for(BLOCKS _ic_y_1 : TRK.relationImage(new BSet<BLOCKS>(_ic_x_1))) {
                ...
                if(!(new BBoolean(!new BBoolean(TRK.domain().elementOf(_ic_x_1).booleanValue() && TRK.relationImage(new BSet<BLOCKS>(_ic_x_1)).elementOf(_ic_y_1).booleanValue()).booleanValue() || _ic_boolean_10.booleanValue())).booleanValue()) {

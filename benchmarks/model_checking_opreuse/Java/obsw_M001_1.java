...
public class obsw_M001_1 {
    ...
    public obsw_M001_1(obsw_M001_1 copy) {
    ...
    private static class ModelChecker {
        ...
        private final LinkedList<obsw_M001_1> unvisitedStates = new LinkedList<>();
        private final Set<obsw_M001_1> states = ConcurrentHashMap.newKeySet();
        ...
        private obsw_M001_1 counterExampleState = null;
        ...
        private void modelCheckSingleThreaded() {
            obsw_M001_1 machine = new obsw_M001_1();
            states.add(machine);
            ...
            while(!unvisitedStates.isEmpty()) {
                ...
                Set<obsw_M001_1> nextStates = generateNextStates(state);
        ...
        private Set<obsw_M001_1> generateNextStates(final obsw_M001_1 state) {
            Set<obsw_M001_1> result = new HashSet<>();
            if(isCaching) {
        ...
        private boolean invariantViolated(final obsw_M001_1 state) {

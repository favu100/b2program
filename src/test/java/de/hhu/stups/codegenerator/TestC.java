...
public class TestC {
    ...
    public void testC(String machine) throws Exception {
        ...
        List<Path> cFilePaths = codeGenerator.generate(mchPath, GeneratorMode.C, false, String.valueOf(Integer.MIN_VALUE), String.valueOf(Integer.MAX_VALUE), "10", false,false,true, null, false);
